...
namespace conflict\classicprison\area;
...
class AreaUpdateTask extends PluginTask {
	...
	public function __construct(AreaManager $manager) {
		...
		parent::__construct($manager->getClassicPrison());
		$manager->getClassicPrison()->getServer()->getScheduler()->scheduleRepeatingTask($this, 20); // execute this task every second
	}
